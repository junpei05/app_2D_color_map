...
ax.scatter(d_0['pH'], d_0['Aw'], marker='s', color=cmap[2], s=400, label='-1～1 log(Nt/N0)')
ax.scatter(d_n1['pH'], d_n1['Aw'], marker='s', color=cmap[1], s=400, label='-1～-3 log(Nt/N0)')
ax.scatter(d_n2['pH'], d_n2['Aw'], marker='s', color=cmap[0], s=400, label='< -3 log(Nt/N0)')
